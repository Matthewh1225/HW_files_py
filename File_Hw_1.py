...
def Assignment(): 
    ...
    #write user typed names to file_0
    ...
    #read names from File 0 & write reverse names into file_1
    ...
    #read names from File 1 & write restored names into file_2
    ...
    #read names from file_2, reverse, sort & print names
